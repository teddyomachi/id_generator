...
module Stat
  ...
  INFO_USER_ACCOUNT_ACTIVATION_SUCCESS = INFO_BASE + 29
  ...
  INFO_SPIN_DOMAIN_EXISTS = INFO_BASE + 57
  INFO_OPT_TRANSACTION_SUCCESS = INFO_BASE + 58
  INFO_NO_RECORDS_DELETED = INFO_BASE + 59
  INFO_DELETE_RECORD_SUCCESS = INFO_BASE + 60
  INFO_MORE_FILES = INFO_BASE + 256

  INFO_CLEAR_CLIPBOARD_SUCCESS = INFO_BASE + 60
  INFO_ADD_RECORD_SUCCESS = INFO_BASE + 61
  INFO_UPDATE_RECORD_SUCCESS = INFO_BASE + 62

  # society5 foundation apps status codes
  INFO_TRANSPORT_BASE = INFO_BASE + 512

  INFO_TRANSPORT_REQUESTING = INFO_TRANSPORT_BASE + 1
  INFO_TRANSPORT_WAITING = INFO_TRANSPORT_BASE + 2
  INFO_TRANSPORT_ACCEPTED = INFO_TRANSPORT_BASE + 3
  INFO_TRANSPORT_CANCELED = INFO_TRANSPORT_BASE + 4
  INFO_TRANSPORT_SUSPNDED = INFO_TRANSPORT_BASE + 5
  INFO_TRANSPORT_CLEARED = INFO_TRANSPORT_BASE + 6

  INFO_ACCEPTING_DRIVERS_LISTING = INFO_TRANSPORT_BASE + 64
  INFO_RESERVED_LISTING = INFO_TRANSPORT_BASE + 65

  # user acount activation status  at login
  INFO_USER_ACCOUNT_ACTIVATED = 1024
  INFO_USER_ACCOUNT_IS_NOT_ACTIVATED = 1025
  ...
  ERROR_FAILED_OPT_TRANSACTION = ERROR_BASE - 76
  ERROR_GROUP_NAME_IS_NOT_ALLOWED = ERROR_BASE - 77
  ...
  ERROR_NO_DISPLAY_DATA = ERROR_BASE - 81
  EXPLODT = '2020/1/1 00:00:00 UTC'
  ...
  # SECRET FILES API
  # SUCCESS
  INFO_SecretFiles_API_BASE = 4096
  INFO_SecretFiles_API_IHAB_LS_SUCCESS = INFO_SecretFiles_API_BASE + 1
  INFO_SecretFiles_API_GET_DOMAIN_LIST_SUCCESS = INFO_SecretFiles_API_BASE + 2
  INFO_SecretFiles_API_ADD_DOMAIN_LIST_SUCCESS = INFO_SecretFiles_API_BASE + 3
  INFO_SecretFiles_API_DELETE_DOMAIN_LIST_SUCCESS = INFO_SecretFiles_API_BASE + 4
  INFO_SecretFiles_API_GET_GROUP_LIST_SUCCESS = INFO_SecretFiles_API_BASE + 5
  INFO_SecretFiles_API_GET_MEMBER_GROUP_LIST_SUCCESS = INFO_SecretFiles_API_BASE + 6
  INFO_SecretFiles_API_ADD_MEMBER_MY_GROUP_SUCCESS = INFO_SecretFiles_API_BASE + 7
  INFO_SecretFiles_API_GET_MAPPING_DATA_SLM_COUNT = INFO_SecretFiles_API_BASE + 100
  # ERROR
  ERROR_SecretFiles_API_BASE = -4096
  # IHAB LS: ノードハッシュからメタ情報を取得できませんでした
  ERROR_SecretFiles_API_IHAB_LS_LIST_NOT_FOUND = ERROR_SecretFiles_API_BASE - 1
  ERROR_SecretFiles_API_GET_DOMAIN_LIST_GET_SESSION = ERROR_SecretFiles_API_BASE - 22
  ERROR_SecretFiles_API_GET_DOMAIN_LIST_GET_DOMAINS = ERROR_SecretFiles_API_BASE - 23
  ERROR_SecretFiles_API_GET_DOMAIN_LIST_GET_GROUPMEMBER = ERROR_SecretFiles_API_BASE - 24
  ERROR_SecretFiles_API_GET_DOMAIN_LIST_GET_USERINFO = ERROR_SecretFiles_API_BASE - 25
  ERROR_SecretFiles_API_ADD_DOMAIN_LIST_FAILED = ERROR_SecretFiles_API_BASE - 26
  ERROR_SecretFiles_API_DELETE_DOMAIN_LIST_FAILED = ERROR_SecretFiles_API_BASE - 27
  ERROR_SecretFiles_API_GET_GROUP_LIST = ERROR_SecretFiles_API_BASE - 41
  ERROR_SecretFiles_API_GET_MEMBER_GROUP_LIST = ERROR_SecretFiles_API_BASE - 61
  ERROR_SecretFiles_API_ADD_MEMBER_MY_GROUP = ERROR_SecretFiles_API_BASE - 81

  ERROR_SecretFiles_API_GET_MAPPING_DATA_SLM_COUNT = ERROR_SecretFiles_API_BASE - 101

  SPIN_SESSION_LOGOUT = 0
  SPIN_SESSION_LOGIN = 1
