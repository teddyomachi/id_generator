...
module SpinLocationManager
  ...
  end   # => end of get_location_coordinates
  ...
  def self.search_domains_of_node node_rec
    ...
    #    end
    return domains
  end # => end of .search_domains_of_node node_key
  ...
  end # => end of self.get_vpath_key virtual_path
  ...
  def self.get_expanded_sub_tree_nodes sid, location, domain_hash_key, root_node_hashkey
    ...
    return tree_nodes
  end # => end of get_expanded_sub_tree_nodes
  ...
  def self.move_location_org move_sid, src, dst
    ...
    return dst
  end # => end of self.move_location src, dst
  ...
  end # => end of self.copy_location src, dst
  ...
  def self.get_parent_key node_key, t = ANY_TYPE
    ...
    sindex = child[:virtual_path].rindex('/')
    ...
    parents = Array.new
    if sindex > 0
      parent_vpath = child[:virtual_path][0..(sindex-1)]
  ...
  end # => end of self.is_in_sub_tree(move_source_folder_hashkey,move_target_folder_hashkey)
  ...
  def self.locate_domain_by_key sid, node_key
    ...
    return nil
  end # => end of locate_domain_by_key
