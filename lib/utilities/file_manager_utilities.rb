...
module FileManager
  ...
  def self.is_alive session_id, server_name = SYSTEM_DEFAULT_SPIN_SERVER
  ...
  def self.is_busy server_name = SYSTEM_DEFAULT_SPIN_SERVER
    my_server_params = SpinFileServer.find_by_server_name server_name
  ...
  def self.logger sid, log_msg, server_name = SYSTEM_DEFAULT_SPIN_SERVER, log_level = LOG_INFO
    ...
    if server_name == 'LOCAL'
      ...
      server_params = SpinFileServer.find_by_server_name server_name
      #      server_params = SpinFileServer.find_by_server_name 'spinlogserver-local'
  ...
  def self.post_request request_params, server_params = nil
    ...
    if server_params.present? # => server params are passed
      ...
      if $my_sever_params_g.present?
        ...
        my_server_params = SpinFileServer.find_by_server_name SYSTEM_DEFAULT_SPIN_SERVER
